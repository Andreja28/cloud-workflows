...
%    'Modeled Gaussian distributions', 'Interpreter', 'LaTeX', 'Location', 'northeast','FontSize',16)
%%
if zz==1
...
%%
csv_output_dataset=mat2dataset(csv_output);
csv_output_dataset.Properties.VarNames = ...
    {'bars_x','bars_y','distr_x','distr_sum_y','distr_1_y','distr_2_y','distr_3_y','distr_4_y','distr_5_y'};
export(csv_output_dataset,'File','baghdadite.csv','Delimiter',',')